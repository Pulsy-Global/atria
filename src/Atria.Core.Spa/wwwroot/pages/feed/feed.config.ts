...
export const FEED_TAB_CONFIGS: Record<TabType, TabConfig> = {
    ...
    [TabType.Filter]: {
        ...
        confirmationMessage:
            'Are you sure you want to close the Filter tab? All unsaved changes will be lost.',
        icon: 'filter_alt',
    },
    [TabType.Function]: {
        label: 'Function',
        ...
        requiresConfirmation: true,
        confirmationMessage:
            'Are you sure you want to close the Function tab? All unsaved changes will be lost.',
        icon: 'functions',
    },
    [TabType.Output]: {
        label: 'Output',
        ...
        requiresConfirmation: true,
        confirmationMessage:
            'Are you sure you want to close the Output tab? All unsaved changes will be lost.',
    ...
    [TabType.Result]: {
        ...
        requiresConfirmation: false,
        confirmationMessage:
            'Are you sure you want to close the Live Preview tab?',
        icon: 'sensors',
    },
